    ...
    */
     ...
     */
       ...
       public function moduleSetup() {
            ...
            $data["breadcrumbs"] = array(
                "Module" => "dashboard/securityAccess/moduleSetup",
            );
     ...
     */
        ...
        public function createModule() {
            ...
            if ($this->utilities->insertData($module, 'ati_modules')) {
                ...
                redirect('dashboard/securityAccess/moduleSetup');
            }
        }
     ...
     */
       ...
       public function moduleLinks() {
            $data["breadcrumbs"] = array(
                "Module Links" => "dashboard/securityAccess/moduleLinks",
            );
     ...
     */
        ...
        function createModuleLink() {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect('dashboard/securityAccess/moduleLinks', 'refresh');
            }
        }


    /**
     * Show Edit Module Link Form 
     * Edit Module Link  
     */
    ...
    /**
     * Show Organization wise Module List
     */
     ...
     */
        ...
        public function addNewGroup() {
            ...
            if ($rs == TRUE) {
                ...
                redirect('dashboard/securityAccess/allGroup', 'refresh');
            } else {
     ...
     */
        ...
        public function addUserBySubproject() {
            ...
            if ($rs == TRUE) {
                ...
                redirect('dashboard/securityAccess/orgModuleSetup', 'refresh');
            } else {
                $this->session->set_flashdata('Error', 'User Group Create Failled.');
                redirect('dashboard/securityAccess/orgModuleSetup', 'refresh');
            }
    ...
    /**
     * Show Assign Module to Level Module
     */
    ...
    /**
     * Get Module access by group level
     */
    ...
    /**
     * Add Parameters by report module
     */
    ...
    /**
     * Add New Report Module Category
     */
        ...
        public function add_new_report_module_cat() {
            if ($_POST) {
                ...
                if ($this->utilities->insertData($insertData, 'pr_module_reportcategory')) {
                    redirect('dashboard/securityAccess/module_report_category', 'refresh');
                }
            }
        }

    /**
     * Get Parameters By Report Module
     */
    ...
    /**
     *Edit Report Module Category page
     */
