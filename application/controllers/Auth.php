 ...
 */
    ...
    public function sendmail_forgot_password() {
        ...
        <a  href='" . site_url() . "/auth/generate_password/$random_id'><button class='btn btn-success' style='background: #10b7e8; height:6%; margin-left:24%;'>Reset Password</button></a> <br/>
        If you the link don't use, simply <a  href='" . site_url() . "/auth/forgot_password'>request a new link.</a> If you didn't initiate this request,<br/>
