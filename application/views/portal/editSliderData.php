...
<script>
 ...
 <div class="widget-body">
         <?php
            ...
            echo form_open_multipart('portal/editImageinSlider/'.$ID, $attribute);
            ?>
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Slider Title ', 'id' => 'title', 'name' => 'title', 'value' => $edit_sliders->IMAGE_TITLE, 'required' => 'required')); ?>      
               </div>
            </div>
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12">
                  ...
                  <?php echo form_textarea(array('name' => 'descript', "class" => "redactor form-control", 'placeholder' => 'Slider Description', 'rows' => '50','value' => $edit_sliders->IMAGE_DESC)); ?>  
               </div>
            </div>
            <div class="col-md-4 help">
                  ...
                  <label for="firstname">Image</label> 
                    ...
                    <?php 
                       foreach($images as $image) {
                           ...
                           <img src="<?php echo base_url();?>resources/images/home_page_slider/<?php echo $image->IMAGE_PATH; ?>" class="img-thumbnail" id="img-thumbnail_id" style="width:130px;height:100px;margin-left:1px;"/>
...
<script>
   ...
   <script>
        $(document).on('click', '.removeImage', function() {
            ...
            $.ajax({
                  type: "POST",
                  url: "<?php echo site_url('portal/delete_images'); ?>",
                  data: {ID:ID},
                  dataType: "html",
                  success: function(data){
                      $('#images_'+ID).remove();
