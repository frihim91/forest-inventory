...
<?php
function noDataReturnParam($param)
{
  if($param=="")
  {
    $printData="No Data";
                              ...
                              <div id="my<?php echo $i.$j; ?>" class="panel-collapse collapse">
                                <div class="panel-body">
                                  ...
                                  <dl class='dl-horizontal' style="margin-bottom: 5px;">
                                    <dt style='font-size:15px'><small>Family Name:</small></dt> <dd style='font-size:15px'><small> <?php echo noDataReturnParam($row->Family);?></small></dd> 
                                    <dt style='font-size:15px'><small>Genus:</small></dt> <dd style='font-size:15px'><small> <?php echo noDataReturnParam($availableData->Genus);?></small></dd> 
