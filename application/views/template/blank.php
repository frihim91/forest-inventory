                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $total_family->TOTAL_FAMILY; ?></div>
                        ...
                        <a href="#">
                            <div class="panel-footer">
                              <a href="<?php echo site_url('dashboard/ForestData/speciesSetup'); ?>"> <span class="pull-left">View Details</span></a>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $total_genus->TOTAL_GENUS; ?></div>
                                    <div>Total Genus</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $total_species->TOTAL_SPECIES; ?></div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $total_ef->TOTAL_EF; ?></div>
                                    <div>Total Emission Factor</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                            <div class="panel-footer">
                                 <a href="<?php echo site_url('dashboard/ForestData/all_ef_data'); ?>"> <span class="pull-right">View Details</span></a>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
