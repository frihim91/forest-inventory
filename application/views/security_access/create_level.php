...
<div class="modal-body">   
    <div class="row">  
        <div class="form-group">
            <div class="col-md-8">
                <label for="firstname" class="col-md-4 control-label">Group Level</label>
                <div class="col-md-8"> 
                    <?php echo form_input(array('class' => 'form-control', 'placeholder' => '', 'id' => 'txtLevelName', 'name' => 'txtLevelName', 'required' => 'required')); ?>      
                    <?php echo form_hidden('txtGroupId', $user_group_id); ?>       
                </div>
            </div>
