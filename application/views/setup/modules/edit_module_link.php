            ...
            <div class="form-group"> 
                <div class="col-md-8">
                    ...
                    <div class="col-md-4"> 
                        ...
                        echo form_dropdown('txtmoduleId', $options, $previousInfo->MODULE_ID, 'id="id" class="tag-select form-control" data-placeholder="Choose a Country..." required="required"');
                        ?>   
                    </div>
                </div>
        ...
        <div class="row">
            <div class="form-group"> 
                <div class="col-md-8">
                    ...
                    <div class="col-md-8"> 
                        <?php echo form_input(array('class' => 'form-control', 'id' => 'txtLinkName', 'name' => 'txtLinkName', 'value' => $previousInfo->LINK_NAME, 'required' => 'required')); ?>      
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">
            <div class="form-group"> 
                <div class="col-md-8">
                    ...
                    <div class="col-md-8"> 
                        <?php echo form_input(array('class' => 'form-control', 'id' => 'txtLinkNameBn', 'name' => 'txtLinkNameBn', 'value' => $previousInfo->LINK_NAME_BN)); ?>      
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">
            <div class="form-group"> 
                <div class="col-md-8">
                    ...
                    <div class="col-md-8"> 
                        <?php echo form_input(array('class' => 'form-control', 'id' => 'txtModLink', 'name' => 'txtModLink', 'value' => $previousInfo->URL_URI, 'required' => 'required')); ?>      
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <div class="col-md-1">
                        <?php echo form_input(array('class' => 'form-control numericOnly', 'id' => 'SL_NO', 'name' => 'SL_NO', 'value' => $previousInfo->SL_NO, 'maxlength' => 2)); ?>      
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">
            <div class="form-group"> 
                <div class="col-md-8">
                    ...
                    <div class="col-md-8"> 
                        <?php echo form_checkbox('ACTIVE_STATUS', 1, ($previousInfo->ACTIVE_STATUS == 1) ? TRUE : FALSE); ?>
                    </div>
                </div>
                <div class="col-md-4 help">
