...
<script>
  ...
  <div class="widget">  
    <div class="widget-head"> 
        <a href="<?php echo site_url('dashboard/Website/viewVideo')?>" class="btn btn-sm btn-danger pull-right col-md-2 Modal" >View Video</a>
        <small style="margin-left: 10px;">Add New Video</small> 
    </div> 

 <div class="widget-body">
         <?php
            $attribute = array('class' => 'form-horizontal', 'id' => '', 'role' => 'form');
            echo form_open_multipart('dashboard/Website/editVideo/'.$ID, $attribute);
            ?>
  ...
  <div class="row">
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  <label for="firstname">Video Title </label>
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Video Title ', 'id' => 'Title', 'name' => 'Title', 'value' => $edit_video->Title, 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
               <strong><span  class="help-head">Help: </span>Video Title Name</strong>
               <hr>
               <p class="muted">Please enter Video Title Name in english here.</p>
            </div>
         </div>
      </div>
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Video URL ', 'id' => 'url', 'name' => 'url', 'value' => $edit_video->url, 'required' => 'required')); ?> 
                   <p style="color:red;font-size:16px;padding-top:10px;">N.B Video Iframe Must be width=320px and height=318px </p>     
               </div>
            </div>
            <div class="col-md-4 help">
               <strong><span  class="help-head">Help: </span>Video URL</strong>
               <hr>
               <p class="muted">Please enter Video URL in english here.</p>
            </div>
         </div>
      </div>
       ...
       <div class="row">
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  <label for="firstname">Video Description </label>
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Video Description ', 'id' => 'video_description', 'name' => 'video_description', 'value' =>  $edit_video->video_description, 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
               <strong><span  class="help-head">Help: </span>Video Description</strong>
               <hr>
               <p class="muted">Please enter Video Description in english here.</p>
            </div>
         </div>
      </div>
