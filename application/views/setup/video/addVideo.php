...
<div class="widget">
   ...
   <div class="widget-body">
      <?php echo form_open_multipart('dashboard/Website/addVideo', "class='form-horizontal margin-none'"); ?>
      <div class="msg">
         <?php
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Video Title ', 'id' => 'Title', 'name' => 'Title', 'value' => set_value('Title'), 'required' => 'required')); ?>      
               </div>
            </div>
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Video URL ', 'id' => 'url', 'name' => 'url', 'value' => set_value('url'), 'required' => 'required')); ?> 
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Video Description ', 'id' => 'video_description', 'name' => 'video_description', 'value' => set_value('video_description'), 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
