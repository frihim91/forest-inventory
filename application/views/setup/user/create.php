    ...
    <div class="widget-body">
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    <label for="cmbInstituteType" class="col-md-3 control-label">User Group <span class="requiredLevel">*</span></label>
                    <div class="col-md-6"> 
                        <?php echo form_dropdown('cmbGroupName', $user_group, "", 'id="cmbGroupName" class="dropdown-option required_field col-md-6"'); ?>
                    </div>
                </div>
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <div class="col-md-3">                             
                        <?php echo form_dropdown('selectLevelName', array('' => 'Select Level'), "", 'id="selectLevelName" class="form-control col-md-3"'); ?>                      
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row subProjectArea">
            <div class="form-group">
                <div class="col-md-8">
                    <label for="selectSubProject" class="col-md-3 control-label">Sub Project <span class="requiredLevel">*</span></label>
                    <div class="col-md-9">
                        <?php echo form_dropdown('selectSubProject', array('' => 'Select Sub Project'), "", 'id="selectSubProject" class="dropdown-option col-md-12"  '); ?>
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <div class="col-md-5"> 
                        <input type="text" class="form-control required_field" name="textFirstName"  id="textFirstName"/>    
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <div class="col-md-5"> 
                        <input type="text" class="form-control" name="textMiddleName" id="textMiddleName"/>                      
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <div class="col-md-5"> 
                        <input type="text" class="form-control required_field" name="textLastName" id="textLastName"/>    
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <div class="col-md-5"> 
                        <?php echo form_dropdown('GENDER', $genders, "", 'id="GENDER" class="dropdown-option col-md-6 required_field"  '); ?>
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <div class="col-md-5"> 
                        <input type="text" class="form-control checkEmail required_field" name="textEmailName"  id="textEmailName" /> 
                        <span id="valid" ></span>
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <div class="col-md-5"> 
                        <input type="text" class="form-control required_field" name="textUserName" id="textUserName" />    
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    <label for="textPassword" class="col-md-3 control-label">Password <span class="requiredLevel">*</span></label>
                    <div class="col-md-5"> 
                        <input type="password" id="password1" class="form-control required_field " name="textPassword"/>    
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <div class="row">  
            <div class="form-group">
                <div class="col-md-8">
                    <label for="textReTypePassword" class="col-md-3 control-label">Re Type Password <span class="requiredLevel">*</span></label>
                    <div class="col-md-5"> 
                        <input type="password" id="password2" class="form-control required_field" name="textReTypePassword"/>    
                    </div>
                </div>
                <div class="col-md-4 help">
        ...
        <center>
            <div class="form-group">
                <div class="col-xs-3 col-xs-offset-3">
                    <button type="submit" class="btn btn-success" id="saveUserInfo"><i class="fa fa-check-circle"></i>Create User </button>
    ...
    $(document).ready(function () {
        ...
        $(document).on("change", "#cmbGroupName", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#selectLevelName').html(data).change();
                }
            });
        });
        ...
        $(document).on('keyup mouseout', '.checkEmail', function () {
        ...
        $(document).on("click", "#saveUserInfo", function (e) {
            ...
            if (isSubmit == 'Yes') {
                ...
                } else if ($('#user_name').hasClass('exist'))  {                  
                    notyfy({
