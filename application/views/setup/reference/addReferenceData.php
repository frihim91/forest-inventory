...
<script>
 ...
 <div class="widget-body">
      <?php echo form_open_multipart('dashboard/website/addReferenceData', "class='form-horizontal margin-none'"); ?>
      <div class="msg">
         <?php
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Reference Name ', 'id' => 'Reference', 'name' => 'Reference', 'value' => set_value('Reference'), 'required' => 'required')); ?>      
               </div>
            </div>
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Author', 'id' => 'Author', 'name' => 'Author', 'value' => set_value('Author'), 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Year', 'id' => 'Year', 'name' => 'Year', 'value' => set_value('Year'), 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Reference Title', 'id' => 'Title', 'name' => 'Title', 'value' => set_value('Title'), 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Journal', 'id' => 'Journal', 'name' => 'Journal', 'value' => set_value('Journal'),)); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Volume', 'id' => 'Volume', 'name' => 'Volume', 'value' => set_value('Volume'), 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Issue', 'id' => 'Issue', 'name' => 'Issue', 'value' => set_value('Issue'), 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Page', 'id' => 'Page', 'name' => 'Page', 'value' => set_value('Page'), 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'URL', 'id' => 'URL', 'name' => 'URL', 'value' => set_value('URL'), )); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
               <strong><span  class="help-head">Help: </span>Page</strong>
         ...
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12"> 
                  ...
                  <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'PDF_label', 'id' => 'PDF_label', 'name' => 'PDF_label', 'value' => set_value('PDF_label'), 'required' => 'required')); ?>      
               </div>
            </div>
            <div class="col-md-4 help">
  ...
  <div class="row">
         <div class="form-group">
            <div class="col-md-8">
               <div class="col-md-12">
                  <label for="firstname">Upload PDF</label> 
