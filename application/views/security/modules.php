        ...
        <div class="widget-body innerAll inner-2x">
            ...
            <div class="row">
                <div class="form-group">
                    <label class="col-md-5 control-label" for="txtModuleName">Module name</label>
                    <div class="col-md-7"><input class="form-control" id="txtModuleName" name="txtModuleName" value="<?php echo set_value('txtModuleName'); ?>"  type="text" required="required" /></div>
                </div>
            </div>
            <hr />
                    ...
                    if (!empty($modules)) {
                        foreach ($modules as $module) {
                            ...
                            <tr class="gradeX">
                                ...
                                <td><span  id="<?php echo $module->MODULE_ID; ?>"  class="editModule btn btn-info btn-xs" title="Edit">Edit</span></td>
                            </tr>
                            <?php
                        }
                    }
...
<script src="<?php echo base_url(); ?>resources/assets/components/modules/admin/tables/datatables/assets/lib/extras/TableTools/media/js/TableTools.min.js"></script>
