        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-12">
                    ...
                    <h4>Success - you've reset your password. Now, review your account recovery information.</h4>
                ...
                <div class="col-sm-12">
                    <div class="well">
                      <?php echo form_open("", "id='recovery_info' method='post'"); ?>
                        <a class="btn btn-primary btn-block" type="submit" href="<?php echo site_url('accounts/userLogin'); ?>">Back to Login</a>
                      <?php echo form_close(); ?>
                    </div>
                </div>
            </div>
