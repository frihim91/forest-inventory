(function ($, window)
{
    var componentsPath = '../../resources/shared/components/';
        ...
        if ($('.dynamicTable').size() > 0)
        {
            $('.dynamicTable').each(function ()
            {
                ...
                else if ($(this).is('.colVis'))
                {
                    $(this).dataTable({
                        "sPaginationType": "bootstrap",
                        "sDom": "<'row separator bottom'<'col-md-3'f><'col-md-2'l><'col-md-6'C>r>t<'row'<'col-md-6'i><'col-md-6'p>>",
                        "oLanguage": {
                            "sLengthMenu": "_MENU_Show "
                        },
                        "oColVis": {
                ...
                else if ($(this).is('.scrollVertical'))
                {
                    $(this).dataTable({
                        ...
                        "sScrollXInner": "100%",
                        "bScrollCollapse": true,
                        "sDom": "<'row separator bottom'<'col-md-12'f>r>t<'row'<'col-md-6'i><'col-md-8'p>>",
                        "fnInitComplete": function () {
                            fnInitCompleteCallback(this);
                        }
                    });
                ...
                else if ($(this).is('.fixedHeaderColReorder'))
                {
                    $(this).dataTable({
                        "sPaginationType": "bootstrap",
                        "sDom": "R<'clear'><'row separator bottom'<'col-md-12'f>r>t<'row'<'col-md-6'i><'col-md-8'p>>",
                        "sScrollX": "100%",
                        "sScrollXInner": "100%",
                        "bScrollCollapse": true,
                        "fnInitComplete": function () {
                ...
                else
                {
                    $(this).dataTable({
                        "sPaginationType": "bootstrap",
                        "sDom": "<'row separator bottom'<'col-md-3'l><'col-md-4 pull-right'f>r>t<'row'<'col-md-6'i><'col-md-8'p>>",
                        "sScrollX": "100%",
                        "sScrollXInner": "100%",
                        "bScrollCollapse": true,
                        "oLanguage": {
