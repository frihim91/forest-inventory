L.Control.SliderControl = L.Control.extend({
    options: {
        ...
        timeStrLength: 24,  // the size of  yyyy-mm-dd hh:mm:ss - if millis are present this will be larger
        maxValue: -1,
        minValue: 0,
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:200px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px;padding-top:15px; margin-top:13px; background-color:#FFFFFF; text-align:center; border-radius:5px;"></div></div>');
